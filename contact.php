...
<section class="contact">
   ...
   <form name="contact-form" method="POST" action="">
      ...
      <div class="form-control">
        ...
        <textarea name="msg" class="box" placeholder="Message"></textarea>
        <!-- <div class="error-hint hidden">Message is required</div> -->
      </div>

      <hr />

      <button type="submit" class="btn" name="send" value="send message">Submit</button>
    </form>
